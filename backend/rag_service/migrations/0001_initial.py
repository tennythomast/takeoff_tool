    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('storage_approach', models.CharField(choices=[('chunked', 'Chunked Storage'), ('complete', 'Complete Document Storage'), ('hybrid', 'Hybrid Storage')], db_index=True, default='complete', help_text='Approach used for storing document content', max_length=20)),
                ('content', models.TextField(blank=True, help_text='Document content or extracted text from file')),
                ('content_search_vector', models.JSONField(blank=True, help_text='Search vector for full-text search capabilities', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='knowledge_bases', to='projects.project')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='rag_queries', to='projects.project')),
        ...
        migrations.AddField(
            model_name='document',
            name='knowledge_base',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='documents', to='rag_service.knowledgebase'),
        ),
        migrations.AddField(
            model_name='chunk',
            name='document',
        ...
        migrations.AddIndex(
            model_name='ragquery',
            index=models.Index(fields=['project', 'created_at'], name='rag_query_project_141914_idx'),
        ),
        migrations.AddIndex(
            model_name='ragquery',
        ...
        migrations.AddIndex(
            model_name='knowledgebase',
            index=models.Index(fields=['project', 'is_active'], name='rag_knowled_project_00d5ba_idx'),
        ),
        migrations.AddIndex(
            model_name='knowledgebase',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['document', 'page_number'], name='rag_documen_documen_5b7dfe_idx'),
        ),
        ...
        migrations.AddIndex(
            model_name='document',
            index=models.Index(fields=['storage_approach'], name='rag_documen_storage_7d270b_idx'),
        ),
        migrations.AddIndex(
            model_name='chunk',
