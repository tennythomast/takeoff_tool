...
from agents.routing import websocket_urlpatterns as agent_websocket_urlpatterns
...
websocket_urlpatterns = prompt_websocket_urlpatterns + agent_websocket_urlpatterns + context_websocket_urlpatterns