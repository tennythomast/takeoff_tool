    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extraction_notes', models.JSONField(blank=True, default=dict, help_text='Notes and metadata from the extraction process')),
        ...
        migrations.AddIndex(
            model_name='takeoffelement',
            index=models.Index(fields=['page_number'], name='takeoff_ele_page_nu_388321_idx'),
        ),
